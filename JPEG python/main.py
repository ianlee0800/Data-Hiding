...
dummyJPEGstruct = {'quant_tables': [cv2.imread(os.path.join(data_dir, 'ALASKA_50774_QF75.jpg'), flags=cv2.IMREAD_UNCHANGED)]}
...
for imgIdx, imgPath in enumerate(imgList, start=1):
    ...
    dummyJPEGstruct = {'quant_tables': [cv2.imread(imgPath, flags=cv2.IMREAD_UNCHANGED)]}
